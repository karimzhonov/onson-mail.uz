    ...
    <section class="pt-20" id="tracker">
        <AtomsContainer>
            <div
                ...
                <div class="flex flex-col items-center font-bold relative text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]">
                    <h2 v-if="useI18n().locale.value === 'ru'" class="text-center text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6x">
                        Получите свою
