    ...
    <div class="flex md:flex-row flex-col-reverse h-full w-full">
        <div class="mr-4">
            ...
            <div class="mt-7 flex gap-8 flex-col">
                <InputGroup>
                    <FloatLabel>
                        <InputNumber id="weight" v-model="data.weight" class="w-full" :disabled="disabled" />
                ...
                <InputGroup>
                    <FloatLabel>
                        <InputNumber id="delivery_price" v-model="data.delivery_price" class="w-full" :disabled="disabled" />
            ...
            <StepItem v-for="step in order_steps" :key="step.step">
                <Step asChild :value="step.step">
                    <div class="flex flex-row justify-center mb-4 flex-auto gap-2">
                        <button class="bg-transparent border-0 inline-flex flex-col justify-center items-center gap-2" :class="{'bg-primary text-primary border-primary': step.step === data.status}">
                            <span :class="[
                            ...
                            <h3 class="font-bold">{{ $t(step.title) }}</h3>
